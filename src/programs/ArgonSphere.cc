...
int main(int argc, char** argv)
{
    ...
    // RunManager->SetUserInitialization(new ArgonSphere(Argon, 50000));
    ...
    // // );
    // // RunManager->SetUserInitialization(new ActionInitialization(PrimaryGeneratorAction, efield, stoppingTime));
