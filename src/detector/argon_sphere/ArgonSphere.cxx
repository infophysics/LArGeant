/**
 * @file ArgonSphere.cxx
 * @author Nicholas Carrara [nmcarrara@ucdavis.edu]
 * @brief 
 * @version 0.1
 * @date 2022-04-27
 */
#include "ArgonSphere.hh"

namespace LArGeant
{
    ArgonSphere::ArgonSphere(Argon argon, G4double radius)
    ...
    ArgonSphere::~ArgonSphere()
    {
    }

    void ArgonSphere::DefineMaterials()
    {
    ...
    G4VPhysicalVolume *ArgonSphere::Construct()
    {
