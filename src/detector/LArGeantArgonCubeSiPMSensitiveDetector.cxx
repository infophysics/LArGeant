/**
 * @file LArGeantArgonCubeSiPMSensitiveDetector.cxx
...
namespace largeant
{
    LArGeantArgonCubeSiPMSensitiveDetector::LArGeantArgonCubeSiPMSensitiveDetector(G4String name)
    ...
    G4bool LArGeantArgonCubeSiPMSensitiveDetector::ProcessHits(G4Step* step, G4TouchableHistory* history)
    {
